  ...
  return (
    <div className="body w-full h-full">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        ...
        <TranslateIcon className="h-10 w-10 p-2 rounded-full hover:bg-gray-100 cursor-pointer"></TranslateIcon>
        <ViewGridIcon className="h-10 w-10 p-2 rounded-full hover:bg-gray-100 cursor-pointer"/>
        <UserIcon className="h-10 w-10 p-2 rounded-full hover:bg-gray-100 cursor-pointer"></UserIcon>
        {/* Avatar */}
        <Avatar url="https://i.ibb.co/SwC1b2Q/avatardefault-92824.png"/>
        </div>
      ...
      <form className="flex flex-col items-center mt-44 flex-grow">
        ...
        src="https://svgshare.com/i/hyW.svg"
        height={150}
        width={300}
        />
        ...
        sm:space-y-0 sm:flex-row sm:space-x-4">
          <button onClick={search} className="btn">Search the World</button>

          
        </div>
        <div>
        <p className="text-gray-400 mt-5">A lightweight Search Engine created with NextJS & Tailwind</p>
        </div>
